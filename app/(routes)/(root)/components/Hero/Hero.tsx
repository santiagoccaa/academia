...
export const Hero = () => {
    return (
        <div className="min-h-screen relative bg-linear-to-t from-violet-50 via-white to-white">
            <Decorador positionY="top-1/2 -translate-y-1/2" positionX="left-0" />
            <Decorador positionY="bottom-0" positionX="right-0" />
            {/* <ExploreCourse /> */}
            <Navbar />
            <PageContainer>
